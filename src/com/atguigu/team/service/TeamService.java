...
public class TeamService {
	...
	public void addMember(Employee e) throws TeamException {
		...
		//该成员已在开发团队中
		if(isExist(e)) {
			throw new TeamException("成员已在开发团队中");
		}
		//该员工正在休假，无法添加
		...
		for (int i = 0; i < total; i++) {
			if(team[i] instanceof Arichitest) {
				numOfArch++;
